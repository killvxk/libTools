...
namespace libTools
{
#ifdef _WIN64
#else
	CONST UCHAR CDasm::OpcodeFlags[256] =
	{
		OP_MODRM,                      // 00
		OP_MODRM,                      // 01
		OP_MODRM,                      // 02
	...
	CONST UCHAR CDasm::OpcodeFlagsExt[256] =
	{
		OP_MODRM,                      // 00
		OP_MODRM,                      // 01
		OP_MODRM,                      // 02
	...
	ULONG __fastcall CDasm::SizeOfCode(_In_ LPVOID Code, UCHAR **pOpcode) CONST
	{
		PUCHAR cPtr;
		UCHAR Flags;
		BOOLEAN PFX66, PFX67;
	...
	ULONG __fastcall CDasm::SizeOfProc(_In_ LPVOID Proc) CONST
	{
		ULONG  Length;
		PUCHAR pOpcode;
		ULONG  Result = 0;
