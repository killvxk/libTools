#ifndef __LIBTOOLS_SOCKETCOMMON_SOCKETREMOTECLIENT_H__
#define __LIBTOOLS_SOCKETCOMMON_SOCKETREMOTECLIENT_H__
...
#endif // !__LIBTOOLS_SOCKETCOMMON_SOCKETREMOTECLIENT_H__
