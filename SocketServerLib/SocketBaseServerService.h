#ifndef __LIBTOOLS_SOCKETSERVER_SOCKETBASESERVERSERVICE_H__
#define __LIBTOOLS_SOCKETSERVER_SOCKETBASESERVERSERVICE_H__
...
#endif // !__LIBTOOLS_SOCKETSERVER_SOCKETBASESERVERSERVICE_H__
