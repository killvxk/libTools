#ifndef __LIBTOOLS_SOCKETCLIENT_SOCKETBASECLIENTSERVICE_H__
#define __LIBTOOLS_SOCKETCLIENT_SOCKETBASECLIENTSERVICE_H__
...
#endif // !__LIBTOOLS_SOCKETCLIENT_SOCKETBASECLIENTSERVICE_H__
